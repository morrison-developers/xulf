...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/andrewmorrison/code/projects/xulf/libs/db/src/lib/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/andrewmorrison/code/projects/xulf/libs/db/src/lib/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:postgres@localhost:5433/xulf-dev?schema=public"
      }
    }
  },
  ...
  "inlineSchemaHash": "c54cf36479273e68f73aee39c8ca7080bc5dc32ae251cdf27529993e5d2c0fef",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "libs/db/src/lib/generated",
    "db/src/lib/generated",
  ]
...
path.join(process.cwd(), "libs/db/src/lib/generated/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "libs/db/src/lib/generated/schema.prisma")
